...
describe('App', () => {
  ...
  it('renders header navigation links and separators', async () => {
    ...
    expect(nativeElement.textContent).toContain('Track Mouse');
    expect(nativeElement.textContent).toContain('Decorate Text');
    expect(nativeElement.textContent).toContain('Capitalize Text');
    ...
    expect(nativeElement.textContent).toContain('Item Selector');
    expect(nativeElement.textContent).toContain('Popover');
  });
